...
export const fetchDrafts = () => request('/drafts')
export const fetchDraft = (id) => request(`/drafts/${id}`)
export const createDraft = (payload) => request('/drafts', { method: 'POST', body: JSON.stringify(payload) })
export const updateDraft = (id, payload) => request(`/drafts/${id}`, { method: 'PUT', body: JSON.stringify(payload) })
export const deleteDraft = (id) => request(`/drafts/${id}`, { method: 'DELETE' })
